...
import { Users, Clock, LayoutDashboard, LogOut, X } from "lucide-react";
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-1">
          <a
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-md text-[#1E3A5F] hover:bg-[#C5DEFF] text-sm font-medium transition-colors"
          >
